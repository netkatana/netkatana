...
http_rules = [
    ...
    HttpRule(
        ...
        validator=csp_child_src_insecure_scheme_source,
    ),
    HttpRule(
        ...
        validator=csp_report_only_child_src_insecure_scheme_source,
    ),
    HttpRule(
        ...
        validator=csp_child_src_ip_source,
    ),
    HttpRule(
        ...
        validator=csp_report_only_child_src_ip_source,
    ),
    ...
    HttpRule(
        ...
        validator=csp_ro_font_src_missing,
    ),
    HttpRule(
        code="headers_csp_font_src_unrestricted",
        severity=Severity.WARNING,
        detail="A wildcard source (*, 'https:', or 'http:') in 'font-src' (or 'default-src') allows fonts from any origin, undermining a directive that is normally expected to be narrowly scoped.",
        validator=csp_font_src_unrestricted,
    ),
    HttpRule(
        code="headers_csp_report_only_font_src_unrestricted",
        severity=Severity.WARNING,
        detail="A wildcard source (*, 'https:', or 'http:') in 'font-src' (or 'default-src') allows fonts from any origin, so report-only telemetry models a weak font policy.",
        validator=csp_ro_font_src_unrestricted,
    ),
    HttpRule(
